...
public class Query4 {
    public static void main(String[] args) {
        ...
        for (Document h : metadata) {
            if (String.valueOf(h.get("highwayname")).equalsIgnoreCase("I-205 NB"))
            {
        ...
        System.out.println("The average travel time for 7-9AM and 4-6PM on September 22, 2011 for the I-205 NB freeway in minutes is " + (stationLength / average) * 60);
        client.close();
    }
}
